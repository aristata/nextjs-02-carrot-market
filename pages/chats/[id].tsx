...
const ChatDetail: NextPage = () => {
  return (
    <Layout canGoBack title="채팅 상세보기">
        ...
        <form className="fixed py-2 bg-white bottom-0 inset-x-0">
          <div className="relative flex items-center max-w-md mx-auto w-full">
            ...
            <div className="absolute inset-y-0 flex py-1.5 pr-1.5 right-0">
              <button className="flex items-center rounded-full bg-orange-500 text-white text-sm px-2 hover:bg-orange-600 focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 cursor-pointer">
                &rarr;
              </button>
            </div>
          </div>
