    ...
    <div className={"bg-slate-400 xl:place-content-center py-20 px-10 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen"}>
      <div className={"bg-white dark:bg-black p-6 rounded-3xl shadow-xl flex flex-col justify-between"}>
        ...
        <div className={"flex justify-between my-2"}>
          <span className={"text-gray-500 dark:text-gray-100"}>Tooly Chair</span>
        ...
        <button
          className="mt-5 p-3 bg-blue-500 text-white text-center rounded-xl w-3/4 block mx-auto
            ...
            dark:bg-black dark:border-white dark:border dark:hover:bg-gray-300 dark:hover:text-amber-500">Checkout
        </button>
      </div>
